...
namespace FruityApp.Controllers
{
    ...
    public class ValuesController : ControllerBase
    {
        ...
        {
            //List<string> fruitList = new List<string>();
            string filepath = @"C:\Users\amaanashiq\Documents\csharp\logging\Swagger Logging\FruityApp\FruityApp\FruitFile.txtSqlLocalDB.exe start v11.0";
        ...
        public string? PostValue([FromBody] string? value)
        {
            ...
            if (value != null && value != "")
            {
                string filepath = @"C:\Users\amaanashiq\Documents\csharp\logging\Swagger Logging\FruityApp\FruityApp\FruitFile.txt";
